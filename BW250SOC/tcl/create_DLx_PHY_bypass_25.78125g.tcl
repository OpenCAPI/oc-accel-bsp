...
set_property -dict {     CONFIG.GT_TYPE {GTY}  \
                         ...
                         CONFIG.TX_MASTER_CHANNEL {X0Y19} CONFIG.RX_MASTER_CHANNEL {X0Y19} \
                         CONFIG.TX_LINE_RATE {25.78125} CONFIG.TX_REFCLK_FREQUENCY {156.25}  \
                         CONFIG.TX_DATA_ENCODING {64B66B} CONFIG.TX_USER_DATA_WIDTH {64}  \
                         CONFIG.TX_INT_DATA_WIDTH {64} CONFIG.TX_BUFFER_MODE {0}  \
